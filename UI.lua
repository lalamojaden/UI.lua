...
local Settings = _G.Jaden -- Updated from _G.Cruuzz
...
-- Clean old instances
pcall(function()
    local Old = GuiParent:FindFirstChild("Jaden_HUB") -- Updated name
...
ScreenGui.Name = "Jaden_HUB" -- Updated name
...
-- ==================================================
_G.Jaden_Main = Main
_G.Jaden_TopBar = TopBar
_G.Jaden_Sidebar = Sidebar
_G.Jaden_TabScroll = TabScroll
_G.Jaden_Content = Content
_G.Jaden_ScreenGui = ScreenGui
_G.Jaden_Toggle = Toggle
_G.Jaden_GuiParent = GuiParent
